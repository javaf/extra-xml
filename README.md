...
| **val** <br/> `()`, `(val)`                                                                                                | get or set content of element <br/>                                                                                       `String val = xml.val();` <br/>                                                                                              `xml.val("family", "Castoridae");` |
| **childVal** <br/> `(name)`, `(name, val)`                                                                                 | get or set value of child element <br/>                                                                                    `String val = xml.childVal("satellite");` <br/>                                                                              `xml.childVal("satellite", "ISS");` |
